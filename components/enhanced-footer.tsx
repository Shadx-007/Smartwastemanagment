      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">Smart Waste</span>
            </div>
            <p className="text-sm text-muted-foreground">
              AI-powered waste management solutions for a cleaner, more sustainable future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/ai-features" className="text-sm text-muted-foreground hover:text-foreground">
                  AI Features
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Smart Waste Segregation System. All rights reserved.
            </p>
